<form action="<?php echo $visor->getUrlSave(); ?>" method="post" >
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <?php echo Form::input( "descripcion", $visor->getObjeto()->descripcion, array('class' => "form-control"))?>
            </td>
        </tr>
        <tr>
            <td><label class="control-label">Dimensión</label></td>
            <td>
                <?php echo Form::input( "dimension", $visor->getObjeto()->dimension, array('class' => "form-control"))?>
            </td>
        </tr>
    </table>
