<form action="<?php echo $visor->getUrlSave(); ?>" method="post" >
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <label class="control-label"><?php echo $visor->getObjeto()->observacion->sector->gremio->nombre; ?></label>
            </td>
        </tr>
        <tr>
            <td><label class="control-label">Sector Oficial</label></td>
            <td>
                <label class="control-label"><?php echo $visor->getObjeto()->observacion->sector->nombre; ?></label>
            </td>
        </tr>
        <tr>
            <td><label class="control-label">Observación Oficial</label></td>
            <td>
                <select name="idobservacionoficial" class="form-control" >
                    <?php
                    foreach($asociados as $asociado) {
                        $selected = "";
                        if($visor->getObjeto()->idobservacionoficial != null && $visor->getObjeto()->idobservacionoficial == $asociado->pk()) {
