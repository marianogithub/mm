...
echo Form::hidden( "iddistrito", $visor->getObjeto()->iddistrito);
...
<div class="panel-footer well well-sm">
	...
	<?php echo Form::button( "Cancelar", "Cancelar", array( 'type' => 'button', 'onClick' => "javascript: location.href='" . $visor->getUrlListado() . "/id=".$visor->getObjeto()->iddistrito."'" , 'class' => "btn") )?>
</div>
</form>