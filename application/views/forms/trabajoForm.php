...
<table>
	...
	<tr>
		...
		<td>
			<?php echo Form::input( "nombretrabajo", $visor->getObjeto()->nombretrabajo, array('class' => "form-control"))?>
		</td>
	</tr>
    <tr>
        <td><label class="control-label">Porcentaje</label></td>
        <td>
            <?php echo Form::input( "porcentaje", $visor->getObjeto()->porcentaje, array('class' => "form-control"))?>
        </td>
    </tr>
</table>	
