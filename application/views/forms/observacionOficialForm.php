<form action="<?php echo $visor->getUrlSave(); ?>" method="post" >
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <label class="control-label"><?php echo $visor->getObjeto()->sector->gremio->nombre; ?></label>
            </td>
        </tr>
        <tr>
            <td><label class="control-label">Sector Oficial</label></td>
            <td>
                <select name="idsectoroficial" class="form-control" >
                    <?php
                    foreach($asociados as $asociado) {
                        $selected = "";
                        if($visor->getObjeto()->idsectoroficial != null && $visor->getObjeto()->idsectoroficial == $asociado->pk()) {
