...
echo Form::hidden( "idzona", $visor->getObjeto()->idzona);
...
<div class="panel-footer well well-sm">
    <?php echo $visor->getConfirmarButton(); ?>
    <?php echo $visor->getCancelarButton(null, "/id=".$visor->getObjeto()->idzona); ?>
    <?php echo Form::submit( "Confirmar", "Confirmar", array('class' => "btn btn-primary" ))?>
	<?php echo Form::button( "Cancelar", "Cancelar", array( 'type' => 'button', 'onClick' => "javascript: location.href='" . $visor->getUrlListado() . "/id=".$visor->getObjeto()->idzona."'" , 'class' => "btn") )?>
</div>
</form>