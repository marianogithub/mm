...
<table>
	...
	<tr>
		...
		<td>
			<?php echo Form::input( "nombredestino", $visor->getObjeto()->nombredestino, array('class' => "form-control"))?>
		</td>
	</tr>
    <tr>
        <td><label class="control-label">Coeficiente de Superficie</label></td>
        <td>
            <?php echo Form::input( "coeficienteSuperficie", $visor->getObjeto()->coeficienteSuperficie, array('class' => "form-control"))?>
        </td>
    </tr>
</table>	
