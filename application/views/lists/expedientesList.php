...
echo Form::button( "volver", "Volver al Panel",
		array( 'onClick' => "javascript: location.href='" . Kohana::$base_url . Kohana::$index_file . "/Panelexpediente/'", 'class' => "btn"  ) ); 
?> 
</div>
...
echo "</thead>";
	//datos de la tabla.-
	$urlObras = Kohana::$index_file . "/Obras/index/id=";
    $urlAdicionales = Kohana::$index_file . "/Adicionales/index/id=";
    $urlInspecciones = Kohana::$index_file . "/Inspecciones/index/id=";
	$urlMovimiento = Kohana::$index_file . "/Movimiento/index/id=";
	$urlObservaciones = Kohana::$index_file . "/Observacionexpte/index/id=";
    $urlFactibilidad = Kohana::$index_file . "/Factibilidad/index/id=";
    $urlImpresionAforo = Kohana::$index_file . "/Imprimiraforo/index/id=";
	echo "<tbody>";
	foreach( $visor->getListado() as $key => $value ) {
        ...
        echo "<td>" . $visor->getEditLink( $id, "Ver Datos" ) . "</td>";
		echo "</tr>";
	}
	echo "</tbody>";
echo "</table>";
