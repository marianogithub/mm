...
/**
  * 
  */
class Controller_Actividadcompleja extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Actividad Compleja";
		$this->encabezado		= "Actividad Compleja";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "actividadcompleja";
		$this->formulario		= "forms/actividadcomplejaForm";
		$this->listado			= "lists/actividadcomplejaList";
	}
