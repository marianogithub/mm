...
/**
  * 
  */
class Controller_Afectacionlimite extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Afectacion Limite";
		$this->encabezado		= "Afectacion Limite";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "afectacionlimite";
		$this->formulario		= "forms/afectacionlimiteForm";
		$this->listado			= "lists/afectacionlimiteList";
	}
