...
/**
  * 
  */
class Controller_Cumplirordenanza extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Cumplir Ordenanza";
		$this->encabezado		= "Cumplir Ordenanza";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "cumplirordenanza";
		$this->formulario		= "forms/cumplirordenanzaForm";
		$this->listado			= "lists/cumplirordenanzaList";
	}
