...
/**
  * 
  */
class Controller_Altura extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Altura";
		$this->encabezado		= "Altura";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "altura";
		$this->formulario		= "forms/alturaForm";
		$this->listado			= "lists/alturaList";
	}
