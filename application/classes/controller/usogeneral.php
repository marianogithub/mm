...
/**
  * 
  */
class Controller_Usogeneral extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Uso General";
		$this->encabezado		= "Uso General";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "usogeneral";
		$this->formulario		= "forms/usoGeneralForm";
		$this->listado			= "lists/usoGeneralList";
	}
