...
/**
  * 
  */
class Controller_Ensancheapertura extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Ensanche Apertura";
		$this->encabezado		= "Ensanche Apertura";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "ensancheapertura";
		$this->formulario		= "forms/ensancheaperturaForm";
		$this->listado			= "lists/ensancheaperturaList";
	}
