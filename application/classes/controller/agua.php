...
/**
  * 
  */
class Controller_Agua extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Agua";
		$this->encabezado		= "Agua";
		$this->nombreColumnas	= Array( "Descripción", "Editar", "Eliminar" );
		$this->nombreTabla		= "Agua";
		$this->formulario		= "forms/aguaForm";
		$this->listado			= "lists/aguaList";
	}
