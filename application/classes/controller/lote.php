...
/**
  * 
  */
class Controller_Lote extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Lotes";
		$this->encabezado		= "Lote";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "lote";
		$this->formulario		= "forms/loteForm";
		$this->listado			= "lists/loteList";
	}
