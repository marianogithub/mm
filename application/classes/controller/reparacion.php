...
/**
  * 
  */
class Controller_Reparacion extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Reparaciones";
		$this->encabezado		= "Reparaciones";
		$this->nombreColumnas	= Array( "Descripción", "Editar", "Eliminar" );
		$this->nombreTabla		= "Reparacion";
		$this->formulario		= "forms/reparacionForm";
		$this->listado			= "lists/reparacionList";
	}
