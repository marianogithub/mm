...
/**
  * 
  */
class Controller_Fuerzamotriz extends App_Controller_Template {
	function __construct($request, $response) {

		parent::__construct($request, $response);

		$this->titulo			= "Fuerza Motriz";
		$this->encabezado		= "Fuerza Motriz";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "fuerzamotriz";
		$this->formulario		= "forms/fuerzamotrizForm";
		$this->listado			= "lists/fuerzamotrizList";
	}
