...
/**
  * 
  */
class Controller_Permisorotura extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Permisos de Rotura";
		$this->encabezado		= "Permisos de Rotura";
		$this->nombreColumnas	= Array( "Descripción", "Editar", "Eliminar" );
		$this->nombreTabla		= "Permisorotura";
		$this->formulario		= "forms/permisoRoturaForm";
		$this->listado			= "lists/permisoRoturaList";
	}
