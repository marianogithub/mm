...
/**
  * 
  */
class Controller_Estacionamiento extends App_Controller_Template {
	function __construct($request, $response) {

		parent::__construct($request, $response);

		$this->titulo			= "Estacionamiento";
		$this->encabezado		= "Estacionamiento";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "estacionamiento";
		$this->formulario		= "forms/estacionamientoForm";
		$this->listado			= "lists/estacionamientoList";
	}
