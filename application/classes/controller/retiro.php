...
/**
  * 
  */
class Controller_Retiro extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Retiro";
		$this->encabezado		= "Retiro";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "retiro";
		$this->formulario		= "forms/retiroForm";
		$this->listado			= "lists/retiroList";
	}
