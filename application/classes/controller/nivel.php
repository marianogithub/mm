...
/**
  * 
  */
class Controller_Nivel extends App_Controller_Template
{
	function __construct($request, $response)
	{
		...
		$this->titulo			= "Nivel";
		$this->encabezado		= "Nivel";
		$this->nombreColumnas	= Array( "Nivel", "Editar", "Eliminar" );
		$this->nombreTabla		= "nivel";
		$this->formulario		= "forms/nivelForm";
		$this->listado			= "lists/nivelList";
	}
