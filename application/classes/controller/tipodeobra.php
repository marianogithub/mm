...
/**
  * 
  */
class Controller_Tipodeobra extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Tipos de Obra";
		$this->encabezado		= "Tipos de Obra";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "tipodeobra";
		$this->formulario		= "forms/tipodeobraForm";
		$this->listado			= "lists/tipodeobraList";
	}
	...
	function action_save() {
		...
		$objeto->nombreobra = $_POST[ "nombreobra" ];
