...
/**
  * 
  */
class Controller_Espacioocupar extends App_Controller_Template {
	function __construct($request, $response) {

		parent::__construct($request, $response);

		$this->titulo			= "Espacio Ocupar";
		$this->encabezado		= "Espacio Ocupar";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "espacioocupar";
		$this->formulario		= "forms/espacioocuparForm";
		$this->listado			= "lists/espacioocuparList";
	}
