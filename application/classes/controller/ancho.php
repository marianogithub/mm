...
/**
  * 
  */
class Controller_Ancho extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Ancho";
		$this->encabezado		= "Ancho";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "ancho";
		$this->formulario		= "forms/anchoForm";
		$this->listado			= "lists/anchoList";
	}
