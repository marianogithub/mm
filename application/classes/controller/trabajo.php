...
/**
  * 
  */
class Controller_Trabajo extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Trabajos";
		$this->encabezado		= "Trabajos";
		$this->nombreColumnas	= Array( "Nombre", "Porcentaje", "Editar", "Eliminar" );
		$this->nombreTabla		= "trabajo";
		$this->formulario		= "forms/trabajoForm";
		$this->listado			= "lists/trabajoList";
	}
	...
	function action_save() {
		...
		$objeto->nombretrabajo = $_POST[ "nombretrabajo" ];
        $objeto->porcentaje = $_POST[ "porcentaje" ];
