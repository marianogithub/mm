...
/**
  * 
  */
class Controller_Iniciarexpediente extends App_Controller_Template {
	function __construct($request, $response) {

		parent::__construct($request, $response);

		$this->titulo			= "Iniciar Expediente";
		$this->encabezado		= "Iniciar Expediente";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "iniciarexpediente";
		$this->formulario		= "forms/iniciarexpedienteForm";
		$this->listado			= "lists/iniciarexpedienteList";
	}
