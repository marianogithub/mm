...
/**
  * 
  */
class Controller_Zonas extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Zonas";
		$this->encabezado		= "Zona";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "zonas";
		$this->formulario		= "forms/zonasForm";
		$this->listado			= "lists/zonasList";
	}
