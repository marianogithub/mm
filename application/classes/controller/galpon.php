...
/**
  * 
  */
class Controller_Galpon extends App_Controller_Template {
	function __construct($request, $response) {
		parent::__construct($request, $response);

		$this->titulo			= "Galpon";
		$this->encabezado		= "Galpon";
		$this->nombreColumnas	= Array( "Nombre", "Editar", "Eliminar" );
		$this->nombreTabla		= "galpon";
		$this->formulario		= "forms/galponForm";
		$this->listado			= "lists/galponList";
	}
