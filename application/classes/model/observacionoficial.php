...
class Model_Observacionoficial extends Modelo
{
...
/// "Deja el nombre de la tabla como se llama la clase y no le hagas cambios"
	...
	protected $_primary_key = 'idobservacion';      // default: id

    protected $_sorting  = array( 'idsectoroficial' => 'ASC', 'nombre' => 'ASC' );

    protected $_belongs_to = array(
        'sector' => array(
            'model' => 'Sectoroficial',
            'foreign_key' => 'idsectoroficial' )
    );
}
?>