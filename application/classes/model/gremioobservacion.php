...
class Model_Gremioobservacion extends Modelo
{
...
/// "Deja el nombre de la tabla como se llama la clase y no le hagas cambios"
	...
	protected $_primary_key = 'idgremioobs';      // default: id

	protected $_sorting  = array( 'nombre' => 'ASC' );

	public function getExternoStr() {
		return $this->externo == 1 ? "Si" : "No";
	}
	public function getGremiosExternos() {
		return ORM::factory($this->_table_name)->where("externo", "=", "1")->find_all();
	}
}
?>