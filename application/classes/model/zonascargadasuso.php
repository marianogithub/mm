...
class Model_Zonascargadasuso extends Modelo
{
...
/// "Deja el nombre de la tabla como se llama la clase y no le hagas cambios"
	...
	protected $_primary_key = 'idzonascargadasuso';      // default: id

	protected $_sorting  = array( 'iduso' => 'ASC' );
