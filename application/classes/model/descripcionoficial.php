...
class Model_Descripcionoficial extends Modelo
{
...
/// "Deja el nombre de la tabla como se llama la clase y no le hagas cambios"
	...
	protected $_primary_key = 'iddescripcion';      // default: id

    protected $_sorting  = array( 'idobservacionoficial' => 'ASC', 'nombre' => 'ASC' );

    protected $_belongs_to = array(
        'observacion' => array(
            'model' => 'Observacionoficial',
            'foreign_key' => 'idobservacionoficial' )
    );
}
?>