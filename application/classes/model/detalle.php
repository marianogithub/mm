...
class Model_Detalle extends Modelo
{
...
/// "Deja el nombre de la tabla como se llama la clase y no le hagas cambios"
	...
	protected $_primary_key = 'iddetalle';      // default: id

    protected $_sorting  = array( 'iddescripcion' => 'ASC', 'nombre' => 'ASC' );

    protected $_belongs_to = array(
        'descripcion' => array(
            'model' => 'Descripcionoficial',
            'foreign_key' => 'iddescripcion' )
    );
}
?>