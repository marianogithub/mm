...
class Model_Zonascargadas extends Modelo
{
...
/// "Deja el nombre de la tabla como se llama la clase y no le hagas cambios"
	...
	protected $_primary_key = 'idzonascargadas';      // default: id
    ...
    public function getCantidadUsos() {
        return ORM::factory("zonascargadasuso")
            ->where("idzonascargadas", "=", $this->pk())
            ->count_all();
    }
}
?>